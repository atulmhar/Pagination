...
from django.urls import path
from .views import UserAPIView  # Import your UserAPIView

urlpatterns = [
    path('users/', UserAPIView.as_view(), name='user_list_create'),  # For listing users and creating a new user
    path('users/<int:pk>/', UserAPIView.as_view(), name='user_detail_update_delete'),  # For retrieving, updating, and deleting a user
]
