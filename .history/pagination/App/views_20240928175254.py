...
class UserViewSet(viewsets.ModelViewSet):
    ...
    pagination_class = CustomUserPagination  # Use custom pagination

    # Override the list method if you want to customize the response
    ...
    # The other methods (create, retrieve, update, destroy) are handled by ModelViewSet
